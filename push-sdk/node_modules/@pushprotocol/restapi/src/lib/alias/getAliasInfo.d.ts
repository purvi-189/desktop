...
import { ALIAS_CHAIN } from '../config';
/**
 *  GET /v1/alias/{aliasAddressinCAIP}/channel
 */
export declare type GetAliasInfoOptionsType = {
 ...
 */
export declare const getAliasInfo: (options: GetAliasInfoOptionsType) => Promise<any>;
