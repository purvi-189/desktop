...
const getPublicKey = (options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const address = account || (yield (signer === null || signer === void 0 ? void 0 : signer.getAddress())) || '';
    const metamaskProvider = new ethers_1.ethers.providers.Web3Provider(window.ethereum);
    const web3Provider = (signer === null || signer === void 0 ? void 0 : signer.provider) || metamaskProvider;
    const keyB64 = yield web3Provider.provider.request({
    ...
    try {
        ...
        switch (encryptionType) {
            case constants_1.default.ENC_TYPE_V1: {
                if ((_a = wallet === null || wallet === void 0 ? void 0 : wallet.signer) === null || _a === void 0 ? void 0 : _a.privateKey) {
                    privateKey = (0, eth_sig_util_1.decrypt)({
                        encryptedData: JSON.parse(encryptedPGPPrivateKey),
                        privateKey: (_b = wallet === null || wallet === void 0 ? void 0 : wallet.signer) === null || _b === void 0 ? void 0 : _b.privateKey.substring(2),
                    });
                }
                else {
                    const metamaskProvider = new ethers_1.ethers.providers.Web3Provider(window.ethereum);
...
const decryptMessage = ({ encryptedPGPPrivateKey, encryptionType, encryptedSecret, pgpPrivateKey, signature, signatureValidationPubliKey, message, }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    let plainText;
...
const decryptAndVerifySignature = ({ cipherText, encryptedSecretKey, publicKeyArmored, signatureArmored, privateKeyArmored, message, }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (message.link == null) {
            ...
            try {
                yield (0, helpers_1.verifySignature)({
                    messageContent: hash,
                    signatureArmored,
                    publicKeyArmored,
                });
...
const encryptPGPKey = (encryptionType, privateKey, wallet, additionalMeta) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    switch (encryptionType) {
        case constants_1.default.ENC_TYPE_V1: {
            let walletPublicKey;
            if ((_c = wallet === null || wallet === void 0 ? void 0 : wallet.signer) === null || _c === void 0 ? void 0 : _c.privateKey) {
                // get metamask specific encryption public key
                walletPublicKey = (0, eth_sig_util_1.getEncryptionPublicKey)((_d = wallet === null || wallet === void 0 ? void 0 : wallet.signer) === null || _d === void 0 ? void 0 : _d.privateKey.substring(2));
            }
            else {
...
const preparePGPPublicKey = (encryptionType, publicKey, wallet) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    switch (encryptionType) {
        ...
        case constants_1.default.ENC_TYPE_V3: {
            const createProfileMessage = 'Create Push Profile \n' + (0, exports.generateHash)(publicKey);
            const { verificationProof } = yield (0, helpers_1.getEip191Signature)(wallet, createProfileMessage);
...
const verifyPGPPublicKey = (encryptedPrivateKey, publicKey, did) => {
    try {
        if (publicKey !== '' && publicKey.includes('signature')) {
            ...
            if (verificationProof.includes('eip712'))
                signedData = 'Create Push Chat Profile \n' + (0, exports.generateHash)(key);
            else
                signedData = 'Create Push Profile \n' + (0, exports.generateHash)(key);
            if ((0, signature_1.verifyProfileSignature)(verificationProof, signedData, (0, address_1.isValidCAIP10NFTAddress)(did)
                ? (0, address_1.pCAIP10ToWallet)(JSON.parse(encryptedPrivateKey).owner)
                : (0, address_1.pCAIP10ToWallet)(did)))
                return publicKey;
            else
                throw new Error('Cannot Verify this publicKey Owner!!!');
        }
        return publicKey;
    }
    catch (err) {
