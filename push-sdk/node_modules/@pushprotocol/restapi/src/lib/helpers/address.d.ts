...
export declare function isValidNFTCAIP10Address(realCAIP10: string): boolean;
/**
 *
 * @param wallet nft:eip155:nftChainId:nftContractAddress:nftTokenId
 * @returns
 */
export declare const isValidCAIP10NFTAddress: (wallet: string) => boolean;
...
export declare const getCAIPWithChainId: (address: string, chainId: number, msg?: string | undefined) => string;
